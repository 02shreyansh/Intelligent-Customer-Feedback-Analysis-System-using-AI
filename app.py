...
if page == "🏠 Dashboard":
    ...
    if uploaded_file is not None:
        ...
        if st.button("Analyze Uploaded Data"):
            with st.spinner("Analyzing feedback..."):
                # Quick sentiment analysis on uploaded data
    ...
    try:
        summaries_df = pd.read_csv('/data/bart_summaries.csv')
...
# ============================================
    ...
    # Load insights data
    try:
        with open('/data/insights_data.json', 'r') as f:
        ...
        issues_df = pd.read_csv('/data/recurring_issues.csv')
        ...
        forecast_df = pd.read_csv('/data/satisfaction_forecast.csv')
...
# ============================================
    ...
    with col1:
        ...
        files = [
            ('/data/cleaned_feedback_data.csv', 'Cleaned Dataset'),
            ('/data/processed_data.csv', 'Processed Data'),
            ('/data/evaluation_metrics.csv', 'Model Metrics'),
            ('/data/recurring_issues.csv', 'Recurring Issues'),
            ('/data/satisfaction_forecast.csv', 'Satisfaction Forecast'),
            ('/data/AI_insights_report.txt', 'Insights Report')
        ]
    ...
    with col2:
        ...
        try:
            st.image('/data/insights_visualization.png', caption='Insights Dashboard')
        except:
    ...
    try:
        with open('/data/AI_insights_report.txt', 'r') as f:
            report = f.read()
